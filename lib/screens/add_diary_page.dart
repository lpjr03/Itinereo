      ...
      return SingleChildScrollView(
        ...
        child: ConstrainedBox(
          constraints: BoxConstraints(
            minHeight: constraints.maxHeight, // forza almeno l'altezza visibile
          ),
          child: Container(
            padding: const EdgeInsets.all(16),
            color: const Color(0xFF649991), // Container blu
            child: Container(
              padding: const EdgeInsets.all(16),
              color: const Color(0xFFF6E1C4), // Container sabbia
              child: Form(
                key: _formKey,
                child: Column(
